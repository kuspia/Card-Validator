const popText = document.querySelector(".popup");
...
function checkLuhn(input) {
  // returns 0 or 1 , 1 means luhn satisfied else 0
  var sum = 0;
...
$("input.cc").keyup(function () {
  // as soon as key is up this will execute
...
popText.addEventListener("mouseover", () => {
  document.querySelector(".popuptext").style.display = "flex";
  document.querySelector(".h2-first").classList.add("blured");
});

popText.addEventListener("mouseleave", () => {
  document.querySelector(".popuptext").style.display = "none";
  document.querySelector(".h2-first").classList.remove("blured");
});
